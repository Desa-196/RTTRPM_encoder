...
//--------------------------------------------------
uint16_t enc28j60PhyReadL(uint8_t address)
{
	// Set the right address and start the register read operation
	enc28j60_writeRegByte(MIREGADR, address);
	enc28j60_writeRegByte(MICMD, MICMD_MIIRD);
	...
	// reset reading bit
	enc28j60_writeRegByte(MICMD, 0x00);
	
	return (enc28j60_readRegByte(MIRDL));
}
//--------------------------------------------------
void enc28j60PhystartScan(uint8_t address)
{
	// Set the right address and start the register read operation
	enc28j60_writeRegByte(MIREGADR, address);
	enc28j60_writeRegByte(MICMD, MICMD_MIISCAN);
...
uint16_t enc28j60PhyReadH(uint8_t address)
{
	...
	return (enc28j60_readRegByte(MIRDH));
}
//--------------------------------------------------
...
//--------------------------------------------------
uint16_t enc28j60_countPacket(void)
{
