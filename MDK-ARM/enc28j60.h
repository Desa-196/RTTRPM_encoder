...
#define SS_SELECT() HAL_GPIO_WritePin(GPIOC, CS_PIN, GPIO_PIN_RESET)
#define SS_DESELECT() HAL_GPIO_WritePin(GPIOC, CS_PIN, GPIO_PIN_SET)
...
#define LD_TG HAL_GPIO_TogglePin(GPIOC, GPIO_PIN_13); //RED
//--------------------------------------------------
